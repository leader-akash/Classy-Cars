...
const BookingDetails = ({ carId }) => {
    ...
    const getCarById = async () => {
        try{
            ...
            setCarData(carData?.data?.getCar)
        }
        catch(err){
            console.log('err', err);
        }
                ...
                <div className=" ml-5 border border-border-color h-[550px] form-container w-[40vw]">
                    <div className="p-5">
                        ...
                        <div className="my-5 flex border border-border-color form-container">
                            <Image src={carData?.image} alt="car" className='w-[250px] h-[140px] m-2 rounded-md' width={300} height={300} />

                            <div className="mx-3">
                                <h4 className="text-[25px] font-semibold ">{carData?.name}</h4>
                                <p>Ratings</p>
                            </div>
                        </div>
